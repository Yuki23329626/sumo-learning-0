...
static void attachToClosestEnb(Ptr<NodeContainer> ueNodes, NetDeviceContainer* ueLteDevs, Ptr<NodeContainer> enbNodes, NetDeviceContainer* enbLteDevs, Ptr<LteHelper> lteHelper, uint16_t numberOfUes, uint16_t numberOfEnbs){
